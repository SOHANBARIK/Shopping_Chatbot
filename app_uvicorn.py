# # server.py – FastAPI server for your RAG backend
# import uvicorn
...
#     print("🚀 Server started with PostgreSQL + Chroma RAG")
#     yield
...
#     # 0️⃣ FIRST: Detect handoff intentions

#         # 0️⃣ FIRST: Detect handoff intent
#     handoff = detect_handoff_intent(q)
#     print("Handoff detector returned:", handoff)

#     # Fallback simple keyword detection
#     fallback_keywords = [
#         "complaint", "helpline", "customer care", "customer support",
#         "refund", "return", "cancel order", "lost order",
#         "support number", "service", "contact", "call support"
#     ]

#     fallback = any(k in q.lower() for k in fallback_keywords)

#     if handoff or fallback:
#         if handoff:
#             topic = handoff.get("topic", "support")
#             contact = handoff.get("contact", HANDOFF_CONTACTS.get("support", {}))
#         else:
#             topic = "support"
#             contact = HANDOFF_CONTACTS.get("support", {})

#         reply_text = (
#             f"{topic.title()} Support:\n"
#             f"Phone: {contact.get('phone','+91-1800-111-222')}\n"
...
#                 return {
#                     "session_id": sid,
#                     "reply": filter_products_by_price(0, int(nums[0]))
#                 }
